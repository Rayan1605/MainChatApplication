...
class Config {
  ...
  constructor() {
    ...
    // Fix: Use CLOUDINARY_CLOUD_NAME to match what the image controller expects
  ...
  public cloudinaryConfig(): void {
    ...
    console.log('   CLOUD_API_KEY:', this.CLOUD_API_KEY ? 'SET' : 'NOT SET');
    console.log('   CLOUD_API_SECRET:', this.CLOUD_API_SECRET ? 'SET' : 'NOT SET');
